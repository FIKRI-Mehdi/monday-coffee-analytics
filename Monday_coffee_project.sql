...
--Q.2 Total revenue from coffee sales. What is the total revenue generated from coffee sales across all cities in the last quarter of 2023?
SELECT * FROM sales
...
-- Q.3 Sales Count for each product. How many units of each coffee product have been sold?
SELECT 
	p.product_id,
	p.product_name,
...
-- How many customers are there in each city who have puchased coffee products ?
